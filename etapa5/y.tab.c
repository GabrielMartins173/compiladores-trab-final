...
{
       0,    69,    69,    72,    73,    74,    77,    78,    79,    80,
      81,    82,    85,    86,    89,    90,    91,    94,    95,    96,
      99,   100,   101,   104,   105,   108,   109,   110,   113,   114,
     115,   118,   119,   120,   123,   126,   127,   128,   129,   130,
...
yyreduce:
  ...
  case 2:
#line 69 "parser.y"
              {Root = (yyval.ast); checkAndSetDeclarations(Root); /*checkUndeclared(Root);*/ checkCommandsType(Root); tacPrintRecursive(generateCode((yyvsp[0].ast)));}
#line 1463 "y.tab.c"
    break;
